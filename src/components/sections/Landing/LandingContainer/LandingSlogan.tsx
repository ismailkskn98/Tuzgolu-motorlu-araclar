...
const LandingSlogan: FC = () => {
  return (
    <motion.article className="relative z-10 backdrop-blur-sm lg:backdrop-blur-0 text-light-white flex flex-col items-center lg:items-start gap-5 w-full lg:w-[55%] mb-4 lg:mb-0 text-center lg:text-left">

...
const ThemeBtn: FC = () => {
  ...
  return (
    <div
      className="relative h-7 w-12 rounded-[32px] px-1 py-2 cursor-pointer flex items-center border justify-start bg-slate-800 dark:justify-end dark:bg-slate-100"
      onClick={themeToggle}
    >
